...
const phrases = [
	...
	`Just keep in mind that we have a bit of a budget here, all of this is requiring us to call in a lot of favors, and that's gonna end up costing a lot of Macca.<br><br>Oh, right; Macca, as the currency of the dead, is sorta like spiritual energy made physical. A loooot of places outside normal realities use it as a type of default currency, and in this case, it's our budget for this whole project.`,
